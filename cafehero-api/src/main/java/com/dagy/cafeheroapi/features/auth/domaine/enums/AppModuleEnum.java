...
import static com.dagy.cafeheroapi.core.constants.ModulePermissions.*;


public enum AppModuleEnum implements RouteOperation{

    AUTHENTICATION {
        public List<AppModuleRoute> pageRoute() {
            return List.of(new AppModuleRoute(
                    "Account",
                    AUTHENTICATION_ACCESS_PAGE_MANAGE_ACCOUNT,
